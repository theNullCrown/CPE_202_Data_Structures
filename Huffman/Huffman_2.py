...
def huffman_decode(encoded_file, decode_file): 
    ...
    if not empty: 
        ...
        temp_string += str(chr(huff_tree.char)) 
        # value that will index into the location w/ the correct code to extract from output_code
        "".join(temp_string) # Format like solution file 
        decode_file.write(str(temp_string)) # Write second and final line to file # Close all files 
        encoded.close()
    elif empty: 
        decode_file.write(" ")
